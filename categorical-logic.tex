...
\begin{defn}
  ...
  A category $\iC$ is $\lambda$-accessible if it has $\lambda$-filtered colimits and it has a set $A$ of $\lambda$-presentable objects such that every object is a $\lambda$-filtered colimit of objects from $A$.
\end{defn}
