...
\begin{rmk}
  A topos, such as $\CSet$, is a ``good'' universe for mathematics.
  In $\CSet$, we make the foundational commitment that $\CSet(A, B)$ is a set and that the ``powerset'' $P(A)$ is a set.
