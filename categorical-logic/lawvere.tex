...
\begin{defn}
  ...
  \item[] Morphisms: a morphism between two idempotents $f : c \to c$ and $g : d \to d$ is a morphism $h : c \to d$ such that the following diagram commutes in $\iC$:
    % https://q.uiver.app/#q=WzAsNCxbMCwwLCJjIl0sWzAsMiwiYyJdLFsyLDAsImQiXSxbMiwyLCJkIl0sWzAsMSwiZiIsMl0sWzIsMywiZyJdLFswLDIsImgiXSxbMSwzLCJoIiwyXSxbMCwzLCJoIiwxXV0=
    \[\begin{tikzcd}
	c && d \\
	\\
	c && d
