...
\begin{defn}
  ...
  A \emph{relation} on an object $A$ of a category $\iC$ is an object $R \in \iC$ with a pair of morphisms $r_{1},r_{2} : R \toto A$.
...
\todo{Investigate what happens when r1 and r2 are monomorphisms.}
