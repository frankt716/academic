...
\begin{defn}\label{defn:lawvere-theory-algebraic-theory}%
  A \emph{Lawvere theory} is an identity-on-objects finite-product preserving functor $p : \dF\op \to \cT$, where $\dF$ is a chosen skeleton of $\CFinSet$ and $\cT$ is a category spanned by finite products of a given object $T$.
\end{defn}
