...
\begin{node}
  ...
  \item\label{node:universal-algebra-cong-2}
    if $s \sim t$ then for any $n \in \dN$ and any terms $u_{1},\ldots,u_{n}$ and any variables $x_{1},\ldots,x_{n}$,
    \[
      s[u_{1},\ldots,u_{n}/x_{1},\ldots,x_{n}] \cng u[u_{1},\ldots,u_{n}/x_{1},\ldots,x_{n}]
    \]
