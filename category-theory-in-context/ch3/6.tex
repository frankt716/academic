...
\begin{proof}
  ...
  For a diagram $D : \iJ \to \iC$, the legs of the limit cones are implemented by composing the binary product projections indicated as follows: \input{img/img6-1} \input{img/img6-2}
  ...
  Thus, $L(f,g,h)$ is given by \input{img/img6-4}
  ...
  \]
  This is satisfied since both composites factor into the following cone: \input{img/img6-5} \input{img/img6-6}
\end{proof}
