...
\input{img/1-adjunction01}

Naturality in both variables then yields
\begin{mathpar}
  \input{img/1-adjunction02} \and \input{img/1-adjunction03}
\end{mathpar}
for arbitrary $k : d \to d'$ and $h : c' \to c$.
Thus, for any $f^{\#} : Fc \to d$, one has the following:
\begin{mathpar}
  \input{img/1-adjunction04} \and \input{img/1-adjunction05}
\end{mathpar}
...
\begin{lem}
  ...
  \begin{mathpar}
    \input{img/1-adjunction06} \and \input{img/1-adjunction07}
  \end{mathpar}
\end{lem}
\begin{proof}
