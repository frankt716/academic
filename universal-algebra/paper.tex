...
Naturality and \cref{lem:T-homomorphism} then ensures that this matches the usual notion of homomorphism.
\input{img/02}
...
\begin{lem}
  ...
  \[
    U : \mathsf{Mod}_{\cT} \to \mathsf{Set}
  \]
  of evaluation at $T^{1}$.
  \begin{enumerate}
  ...
  \item $\cT(T^{1}, \blank)$ is a dense generator for $\mathsf{Mod}_{\cT}$.
  \end{enumerate}
\end{lem}
\begin{proof}
